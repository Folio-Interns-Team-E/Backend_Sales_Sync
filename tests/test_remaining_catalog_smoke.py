...
def test_remaining_api_contract_route_exists(case_id: str, method: str, path: str):
...
def test_remaining_frontend_surface_is_present(case_id: str):
    route_sources = "\n".join(
...
def test_remaining_infrastructure_disposition(case_id: str, reason: str):
