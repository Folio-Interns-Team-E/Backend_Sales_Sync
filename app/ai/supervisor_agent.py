...
class SupervisorAgent:
    ...
    async def _synthesize_response(
        ...
        system_prompt = f"""You are an elite enterprise B2B sales supervisor assistant.
        Your job is to review the raw "Execution Result" generated by system actions alongside the "User Message", 
        and synthesize a highly polished, friendly, executive-level conversational markdown response.
        ...
        RECENT CONVERSATIONAL HISTORY (Last 5 Messages, Oldest to Newest):
        \"\"\"
        ...
        SYNTHESIS AND FORMATTING RULES:
        1. Keep the tone executive-ready, helpful, clear, and professional.
        2. Explain which operations succeeded (e.g. meetings scheduled/canceled, leads compiled, profiles updated) and clarify any issues gracefully.
        3. Convert raw tracking numbers, event UIDs, or structured lists from the "Execution Result" into beautiful, easily readable paragraph.
        4. Address the user directly based on their original message intent.
        5. Do NOT return JSON. Return ONLY clean, valid, styled paragraph.
        6. Keep the message short and to the point.
        7. Also whatever the action was it was completed succesfully before reaching you.
        """
